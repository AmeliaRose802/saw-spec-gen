...
./verify.ps1 `
    -CppFile     end-to-end-test\vtable_havoc_spec_demos\throws_exception\add_one_verified.cpp `
    -CryptolSpec end-to-end-test\vtable_havoc_spec_demos\throws_exception\add_one_spec.cry `
    -CryptolFn   add_one_spec `
    -Function    add_one

# Throws case — DISPROVED ( with counterexample x = 42)
./verify.ps1 `
    -CppFile     end-to-end-test\vtable_havoc_spec_demos\throws_exception\add_one_throws.cpp `
    -CryptolSpec end-to-end-test\vtable_havoc_spec_demos\throws_exception\add_one_spec.cry `
    -CryptolFn   add_one_spec `
    -Function    add_one
```
