...
#[path = "bitcode_overrides_scan_support.rs"]
mod scan_support;
...
pub fn scan_and_emit(
    ...
    scan_support::scan_and_emit_with(
        llvm_ir_path,
        target_symbol,
        already_covered,
        all_globals,
        container_catalog,
        extern_override_scan::scan,
    )
}

/// Opt-in companion for compiler-validated typed object layouts.
/// Attempt defined STL/mutex helpers; retain the legacy contracts for
/// opaque leaves and varargs bodies, coverage filtering and I/O handling.
pub fn scan_and_emit_typed(
    llvm_ir_path: Option<&std::path::Path>,
    target_symbol: &str,
    already_covered: &[String],
    all_globals: &[GlobalVarInfo],
    ...
    scan_support::scan_and_emit_with(
        ...
        all_globals,
        container_catalog,
        extern_override_scan::scan_typed,
    )
}
...
#[cfg(test)]
#[path = "bitcode_overrides_typed_tests.rs"]
mod typed_tests;
