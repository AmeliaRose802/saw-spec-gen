...
.EXAMPLE
    .\verify.ps1 -CppFile demos\add_one.cpp -CryptolSpec demos\add_one_spec.cry -CryptolFn add_one_spec -Function add_one
    .\verify.ps1 -CppFile demos\add_one.cpp -CryptolSpec demos\add_one_spec.cry -CryptolFn add_one_spec -Function add_one -OutputDir my_output
#>
