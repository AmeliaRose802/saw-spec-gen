...
@{
    Cases = @(
        ...
        @{ Tag = 'strings'; Runner = 'custom'; Script = 'demo/strings/run_string_demo.ps1'; ScriptArgs = @{ CppFile = 'demo/strings/count_digits_string_unsat.cpp'; ExpectedResult = 'DISPROVED' }; Expected = 'DISPROVED' }
