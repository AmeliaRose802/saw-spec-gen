...
@{
    Cases = @(
        ...
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/nothing_sketchy';            File = 'add_one_verified.cpp';                   Expected = 'VERIFIED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/nothing_sketchy';            File = 'add_one_disproved.cpp';                  Expected = 'DISPROVED' }
        ...
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/concrete_type_safe';         File = 'add_one_verified.cpp';                   Expected = 'DISPROVED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/concrete_type_safe';         File = 'add_one_disproved.cpp';                  Expected = 'DISPROVED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/class_member_clobbered';     File = 'add_one_verified.cpp';                   Expected = 'VERIFIED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/class_member_clobbered';     File = 'add_one_disproved.cpp';                  Expected = 'DISPROVED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/global_memory_clobbered';    File = 'add_one_verified.cpp';                   Expected = 'VERIFIED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/global_memory_clobbered';    File = 'add_one_disproved.cpp';                  Expected = 'DISPROVED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/input_param_modified';       File = 'add_one_verified.cpp';                   Expected = 'VERIFIED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/input_param_modified';       File = 'add_one_disproved.cpp';                  Expected = 'DISPROVED' }
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/output_param_uninitialized'; File = 'add_one_verified.cpp';                   Expected = 'VERIFIED' }
        ...
        @{ Tag = 'cpp_havoc'; Runner = 'cpp'; Dir = 'demos/02-havoc-coverage/multi_method_ordering';      File = 'call_report_verified.cpp';               Expected = 'VERIFIED' }
        ...
        @{ Tag = 'rust_havoc'; Runner = 'rust'; Dir = 'demos/03-rust-trait-dispatch/dynamic_dispatch';  File = 'add_one_disproved.rs'; Expected = 'DISPROVED' }
        @{ Tag = 'rust_havoc'; Runner = 'rust'; Dir = 'demos/03-rust-trait-dispatch/external_crate';    File = 'add_one_verified.rs';  Expected = 'VERIFIED'  }
        ...
        @{ Tag = 'string_ops'; Runner = 'cpp'; Dir = 'demos/05-string-ops/has_null_byte'; File = 'has_null_byte_verified.cpp';  Cry = 'has_null_byte_spec.cry'; CryptolFn = 'has_null_byte_spec'; Function = 'has_null_byte'; Expected = 'VERIFIED'  }
        @{ Tag = 'string_ops'; Runner = 'cpp'; Dir = 'demos/05-string-ops/has_null_byte'; File = 'has_null_byte_disproved.cpp'; Cry = 'has_null_byte_spec.cry'; CryptolFn = 'has_null_byte_spec'; Function = 'has_null_byte'; Expected = 'DISPROVED' }
        ...
        @{ Tag = 'trait_unknown_impl'; Runner = 'custom'; Script = 'demos/03-rust-trait-dispatch/unknown_impl/run_unknown_impl.ps1'; ScriptArgs = @{ RustFile = 'demos/03-rust-trait-dispatch/unknown_impl/add_step_verified.rs';  ExpectedResult = 'VERIFIED'  }; Expected = 'VERIFIED'  }
        @{ Tag = 'trait_unknown_impl'; Runner = 'custom'; Script = 'demos/03-rust-trait-dispatch/unknown_impl/run_unknown_impl.ps1'; ScriptArgs = @{ RustFile = 'demos/03-rust-trait-dispatch/unknown_impl/add_step_disproved.rs'; ExpectedResult = 'DISPROVED' }; Expected = 'DISPROVED' }
        ...
        @{ Tag = 'box_allocator'; Runner = 'rust'; Dir = 'demos/99-research/box_allocator';        File = 'add_one.rs'; Expected = 'UNKNOWN' }
    )
}
