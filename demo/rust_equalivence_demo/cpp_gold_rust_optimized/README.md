...
.\verify-equiv.ps1 `
    -CppFile     demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add.cpp `
    -RustFile    demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_good.rs `
    -CryptolSpec demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_spec.cry `
...
.\verify-equiv.ps1 `
    -CppFile     demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add.cpp `
    -RustFile    demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_bad.rs `
    -CryptolSpec demo\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_spec.cry `
    -CryptolFn   sat_add_spec `
    -Function    sat_add
```
