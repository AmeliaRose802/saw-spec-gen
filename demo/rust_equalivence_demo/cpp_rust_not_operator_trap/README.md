...
```powershell
.\verify-equiv.ps1 `
    -CppFile     demo\rust_equalivence_demo\cpp_rust_not_operator_trap\negate.cpp `
    -RustFile    demo\rust_equalivence_demo\cpp_rust_not_operator_trap\negate.rs `
    -CryptolSpec demo\rust_equalivence_demo\cpp_rust_not_operator_trap\negate_spec.cry `
