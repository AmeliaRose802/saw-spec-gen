...
A sound tool MUST report VERIFIED.

ORIGINAL BUG:
  Tool reported DISPROVED with a fake counterexample. The auto-generated
...
FIX (applied):
  ...
  See `end-to-end-test/vtable_havoc_spec_demos/adversarial_holes/README.md`.
*/
