...
```powershell
.\verify-equiv.ps1 `
    -CppFile     end-to-end-test\rust_equalivence_demo\cpp_rust_not_operator_trap\negate.cpp `
    -RustFile    end-to-end-test\rust_equalivence_demo\cpp_rust_not_operator_trap\negate.rs `
    -CryptolSpec end-to-end-test\rust_equalivence_demo\cpp_rust_not_operator_trap\negate_spec.cry `
