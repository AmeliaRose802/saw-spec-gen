...
Write-Host '    ./verify.ps1 -CppFile e2e-tests/01-tutorial/bounded_loop/add_one_verified.cpp `' -ForegroundColor White
Write-Host '                 -CryptolSpec e2e-tests/01-tutorial/bounded_loop/add_one_spec.cry `' -ForegroundColor White
