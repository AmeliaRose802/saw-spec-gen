...
/*
DEMO: Unsat because the concrete type's method clobbers global memory

Unlike the sat version which uses OkLog (safe implementation),
...
COMPARE: add_one_sat.cpp uses OkLog — same non-const method,
