//! Async fn verification support for `gen-verify-rust`.
//!
//! When the IR contains a `_RNC`-prefixed coroutine resume symbol for the
//! target function, `gen-verify-rust` automatically targets the resume body
//! rather than the constructor shim.
