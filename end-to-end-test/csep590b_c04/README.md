...
# C++ side
.\verify.ps1 `
    -CppFile     end-to-end-test\csep590b_c04\p1_clamp_sub\clamp_sub_fixed.cpp `
    -CryptolSpec end-to-end-test\csep590b_c04\p1_clamp_sub\clamp_sub_spec.cry `
    -CryptolFn   clamp_sub_spec `
    -Function    clamp_sub

# Rust side
.\verify-rust.ps1 `
    -RustFile    end-to-end-test\csep590b_c04\p1_clamp_sub\clamp_sub_fixed.rs `
    -CryptolSpec end-to-end-test\csep590b_c04\p1_clamp_sub\clamp_sub_spec.cry `
    -CryptolFn   clamp_sub_spec `
    -Function    clamp_sub
```
