...
Write-Host '    ./verify.ps1 -CppFile tests/e2e/cases/01-tutorial/bounded_loop/add_one_verified.cpp `' -ForegroundColor White
Write-Host '                 -CryptolSpec tests/e2e/cases/01-tutorial/bounded_loop/add_one_spec.cry `' -ForegroundColor White
