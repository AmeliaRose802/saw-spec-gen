...
.\verify-equiv.ps1 `
    -CppFile     end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add.cpp `
    -RustFile    end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_good.rs `
    -CryptolSpec end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_spec.cry `
...
.\verify-equiv.ps1 `
    -CppFile     end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add.cpp `
    -RustFile    end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_bad.rs `
    -CryptolSpec end-to-end-test\rust_equalivence_demo\cpp_gold_rust_optimized\sat_add_spec.cry `
    -CryptolFn   sat_add_spec `
    -Function    sat_add
```
